        ...
        while (escolhaPrincipal != 5) {
            ...
            switch (escolhaPrincipal) {
                ...
                case 4:
                    ...
                    break;
                case 5:
                    System.out.println("Voc�  escolheu a op��o sair. Obrigado!");
                    System.exit(0);
                    break;
                default:
                    System.out.println("Voc� n�o escolheu uma op��o valida,retornar para o menu principal Obrigado!");
                    break;
            }
        }
    ...
    public static void escolhaCadastro() throws ClienteException, RepositorioClienteException, EnderecoException, ProdutoException, RepositorioProdutoException, FuncionarioException, RepositorioFuncionarioException, FiliadoException, RepositorioFiliadoException {
        ...
        switch (escolhaSub) {
            ...
            case 6:
                ...
                break;
            case 7:
                System.out.println("Voc�  escolheu a op��o voltar ao Menu, Obrigado!");
                break;
            default:
                System.out.println("Voc� n�o escolheu uma op��o valida,retornar para o menu principal Obrigado!");
                break;
    ...
    public static void escolhaEmpresa() throws VendaException, RepositorioVendaException, FinanceiroExcepiton, RepositorioFinanceiroException, EmpresaException, RepositorioEmpresaException {
        ...
        switch (escolhaSub) {
            case 1:
                ...
                System.out.println("");
                System.out.println(" Patrimonio Atual � R$" + patrimonioAtual);
                System.out.println("");
            ...
            case 3:
                try {
                    ...
                    System.out.println("");
                    System.out.println("O valor gasto com Salario �  R$" + somarTotalSalario);
                    System.out.println("");
                    f = fachada.pesquisarFinanceiroPeloCodigo(1);
            ...
            case 4:
                ...
                break;
            case 5:
                System.out.println("Voc� escolheu a op��o voltar obrigado!");
                break;
            default:
                System.out.println("Voc� n�o escolheu uma op��o Valida");
                break;
        }
                            ...
                            if (clientePfPesquisa != null) {
                                ...
                                switch (tipoEscolhaSub) {
                                    ...
                                    case 2:
                                        ...
                                        break;
                                    case 3:
                                        System.out.println("Voc�  escolheu uma op��o volta");
                                        break;
                                    default:
                                        System.out.println("Voc� N�o escolheu uma op��o valida");
                                        break;
                        ...
                        try {
                            ...
                            if (tipoPesquisa == 1) {
                                ...
                                if (clientePesquisarCNPJ != null) {
                                    ...
                                    System.out.println(" ");
                                    System.out.println("Codigo do Cliente PJ : " + clientePesquisarCNPJ.getCodCliente() + "Raz�o Social :" + clientePesquisarCNPJ.getRazaoSocial()
                                            + "CNPJ :" + clientePesquisarCNPJ.getCNPJ());
                                } else {
                                    System.out.println("ClientePJ N�o Encontrado ");
                                }
                            } else if (tipoPesquisa == 2) {
                        ...
                        case 1:
                            ...
                            if (produtoPesquisa != null) {
                                ...
                                System.out.println("Codigo: " + produtoPesquisa.getCodProduto() + "Nome :" + produtoPesquisa.getNomeProduto()
                                        + "Pre�o :" + produtoPesquisa.getPreco());
                            } else {
                    ...
                    switch (tipoPesquisa) {
                        case 1:
                            ...
                            if (filiadoPesquisa != null) {
                                ...
                                System.out.println("Filiado n�o Encontrado ");
                            }
                            break;
                        case 2:
                            System.out.println("Digite o CNPJ do Filiado");
            ...
            case 7:
                try {
                    ...
                    if (financeiroPesquisa != null) {
                        ...
                        System.out.println("Financeiro N�o Encontrado ");
                    }
                } catch (FinanceiroExcepiton e) {
                    System.out.println(e.getMessage());
                } catch (RepositorioFinanceiroException ex) {
